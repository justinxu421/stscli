...
func GetData() []Map {
   ...
   },
   {
      ...
      "Cost":"2",
      "CostPlus":"1",
      "Text":"Shuffle an [[Omega]] into draw pile. \n#Exhaust.",
   },
   {
      "Name":"Bite",
      "Image":"Bite.png",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"0",
      "Text":"#Retain. Draw [2|3] cards. #Exhaust.",
   },
   {
      "Name":"J.A.X.",
      "Image":"J.A.X..png",
   ...
   {
      "Name":"Ritual Dagger",
      "Image":"RitualDagger.png",
      "Color":"Colorless",
      "Rarity":"Special",
      "Type":"Attack",
      "Cost":"1",
      "Text":"Deal 15 damage. If #Fatal, permanently increase this card\\'s damage by [3|5].\n#Exhaust.",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"#Retain. Gain [12|16] #Block. #Exhaust.",
   ...
   },
   {
      ...
      "Type":"Attack",
      "Cost":"1",
      "Text":"#Retain. Deal [12|16] damage. #Exhaust.",
      
   },
   {
      "Name":"Through Violence",
      "Image":"ThroughViolence.png",
      "Color":"Colorless",
      "Rarity":"Special",
      "Type":"Attack",
      "Cost":"0",
      "Text":"#Retain. Deal [20|30] damage. #Exhaust.",
   ...
   {
      "Name":"Endless Agony",
      "Image":"EndlessAgony.png",
      "Color":"Green",
      "Rarity":"Uncommon",
      "Type":"Attack",
      "Cost":"0",
      "Text":"Whenever you draw this card, add a copy of it into your hand.\nDeal [4|6] damage.\n#Exhaust.",
      
   },
   {
      "Name":"Escape Plan",
      "Image":"EscapePlan.png",
      "Color":"Green",
      "Rarity":"Uncommon",
      "Type":"Skill",
      "Cost":"0",
   ...
   },
   {
      ...
      "Image":"InfiniteBlades.png",
      "Color":"Green",
      "Rarity":"Uncommon",
      "Type":"Power",
      "Cost":"1",
      "Text":"|#Innate. ]At the start of your turn, add a #Shiv into your hand.",
   },
   {
      "Name":"Leg Sweep",
      "Image":"LegSweep.png",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"-2",
      "Text":"#Unplayable.\nIf this card is discarded from your hand, draw [2|3] [card|cards].",
      
   },
   {
      "Name":"Riddle with Holes",
      "Image":"RiddleWithHoles.png",
      "Color":"Green",
      "Rarity":"Uncommon",
      "Type":"Attack",
      "Cost":"2",
   ...
   },
   {
      ...
      "Type":"Attack",
      "Cost":"1",
      "Text":"Deal [5|8] damage.\nIf the enemy has #Vulnerable, gain <R> and draw 1 card.",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"This turn, your next [Attack is|[1|2] Attacks are] played twice.",
   ...
   },
   {
      ...
      "Type":"Power",
      "Cost":"1",
      "Text":"At the start of your turn, trigger the passive ability of your next Orb| [1|2] times].",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"Lose [1|2] focus. Gain [1|2] Strength. Gain [1|2] Dexterity.",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"This turn, your next| [1|2]] Power [card is|cards are] played twice.",
      
   },
   {
      "Name":"Biased Cognition",
      "Image":"BiasedCognition.png",
      "Color":"Blue",
      "Rarity":"Rare",
      "Type":"Power",
      "Cost":"1",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"2",
      "Text":"Enter #Calm. Gain [8|12] #Block.",
      
   },
   {
      "Name":"Bowling Bash",
      "Image":"BowlingBash.png",
      "Color":"Purple",
      "Rarity":"Common",
      "Type":"Attack",
      "Cost":"1",
   ...
   },
   {
      ...
      "Cost":"1",
      "CostPlus":"0",
      "Text":"#Retain. Enter #Wrath. #Exhaust.",
      
   },
   {
      "Name":"Crush Joints",
      "Image":"CrushJoints.png",
      "Color":"Purple",
      "Rarity":"Common",
      "Type":"Attack",
      "Cost":"1",
      "Text":"Deal [8|10] damage. If the previous card played was a Skill, apply [1|2] #Vulnerable.",
      
   },
   {
      "Name":"Cut Through Fate",
      "Image":"CutThroughFate.png",
      "Color":"Purple",
      "Rarity":"Common",
      "Type":"Attack",
      "Cost":"1",
      "Text":"Deal [7|9] damage. #Scry [2|3]. Draw 1 card.",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"Gain [6|10] #Block. Shuffle an #Insight into your draw pile.",
      
   },
   {
      "Name":"Flurry of Blows",
      "Image":"FlurryOfBlows.png",
      "Color":"Purple",
      "Rarity":"Common",
      "Type":"Attack",
      "Cost":"0",
      "Text":"Deal [4|6] damage. On #Stance change, returns from the Discard Pile into your hand.",
      
   },
   {
      "Name":"Flying Sleeves",
      "Image":"FlyingSleeves.png",
      "Color":"Purple",
      "Rarity":"Common",
      "Type":"Attack",
      "Cost":"1",
      "Text":"#Retain. Deal [4|6] damage twice.",
   ...
   },
   {
      ...
      "Type":"Attack",
      "Cost":"1",
      "Text":"Deal [7|11] damage. If the previous card played was an Attack, gain <P>.",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"0",
      "Text":"Gain [3|4] #Block. #Wrath: Gain [9|14] additional #Block.",
   ...
   },
   {
      ...
      "Type":"Attack",
      "Cost":"0",
      "Text":"#Scry [1|2]. Gain [2|3] #Block. Deal [3|4] damage.",
      
   },
   {
      "Name":"Pressure Points",
      "Image":"PressurePoints.png",
      "Color":"Purple",
      "Rarity":"Common",
      "Type":"Skill",
      "Cost":"1",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"0",
      "Text":"Gain [2|3] #Mantra. Gain 4 #Block.",
   ...
   },
   {
      ...
      "Cost":"1",
      "CostPlus":"0",
      "Text":"#Retain. Enter #Calm. #Exhaust.",
      
   },
   {
      "Name":"Battle Hymn",
      "Image":"BattleHymn.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Power",
      "Cost":"1",
      "Text":"|#Innate. ]At the start of each turn add a #Smite into your hand.",
   },
   {
      "Name":"Carve Reality",
      "Image":"CarveReality.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Attack",
      "Cost":"1",
      "Text":"Deal [6|10] damage. Add a #Smite into your hand.",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"X",
      "Text":"Put an Upgraded #Miracle into your hand at the start of your next [X|X+1] turns. #Exhaust",
   ...
   },
   {
      ...
      "Image":"DeceiveReality.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Skill",
      "Cost":"1",
      "Text":"Gain [4|7] #Block. Add a #Safety into your hand.",
   ...
   },
   {
      ...
      "Type":"Power",
      "Cost":"2",
      "Text":"Gain [3|4] #Strength. \nGain [3|4] #Dexterity. \nGain 1 less <P> at the start of each turn.",
      
   },
   {
      "Name":"Fear No Evil",
      "Image":"FearNoEvil.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Attack",
      "Cost":"1",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"Put [1 card|2 cards] from your dsicard pile into your hand and #Retain [it|them]. Enter #Calm. End your turn.",
      
   },
   {
      "Name":"Mental Fortress",
      "Image":"MentalFortress.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Power",
      "Cost":"1",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"Gain [3|4] #Mantra. Shuffle an #Insight into your draw pile.",
      
   },
   {
      "Name":"Reach Heaven",
      "Image":"ReachHeaven.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Attack",
      "Cost":"2",
      "Text":"Deal [10|15] damage. Shuffle a [[Through Violence]] into your draw pile.",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"Gain [6|9] #Block. If the previous card played was a Skill, draw 2 cards.",
      
   },
   {
      "Name":"Sands of Time",
      "Image":"SandsofTime.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Attack",
      "Cost":"4",
      "Text":"#Retain. Deal [20|26] damage. Whenever this card is #Retained, lower its cost by 1.",
      
   },
   {
      "Name":"Signature Move",
      "Image":"SignatureMove.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Attack",
      "Cost":"2",
      "Text":"Can only be played if this is the only attack in your hand. Deal [30|40] damage.",
      
   },
   {
      "Name":"Simmering Fury",
      "Image":"SimmeringFury.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Skill",
      "Cost":"1",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"2",
      "Text":"Gain [8|11] #Block. The next Attack you play costs 0.",
      
   },
   {
      "Name":"Talk to the Hand",
      "Image":"TalktotheHand.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Attack",
      "Cost":"1",
      "Text":"Deal [5|7] damage. Whenever you attack this enemy, gain [2|3] #Block. #Exhaust.",
   ...
   },
   {
      ...
      "Image":"WindmillStrike.png",
      "Color":"Purple",
      "Rarity":"Uncommon",
      "Type":"Attack",
      "Cost":"2",
      "Text":"#Retain. Deal [7|10] damage. Whenever this card is #Retained, increase its damage by [4|5].",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"|#Innate. ]Shuffle a [[Beta]] into your draw pile. #Exhaust.",
   },
   {
      "Name":"Blasphemy",
      "Image":"Blasphemy.png",
   ...
   {
      "Name":"Conjure Blade",
      "Image":"ConjureBlade.png",
      "Color":"Purple",
      "Rarity":"Rare",
      "Type":"Skill",
      "Cost":"X",
      "Text":"Shuffle an #Expunger| with X+1] into your draw pile. #Exhaust.",
      
   },
   {
      "Name":"Deus Ex Machina",
      "Image":"DeusExMachina.png",
      "Color":"Purple",
      "Rarity":"Rare",
      "Type":"Skill",
      "Cost":"Unplayable",
      "Text":"#Unplayable. When you draw this card, add [2|3] #Miracles into your hand. #Exhaust.",
   },
   {
      "Name":"Deva Form",
      "Image":"DevaForm.png",
      ...
      "Type":"Power",
      "Cost":"3",
      "Text":"[#Ethereal. |At the start of your turn, gain <P> and increase this gain by 1.",
   },
   {
      "Name":"Devotion",
      "Image":"Devotion.png",
   ...
   },
   {
      ...
      "Type":"Skill",
      "Cost":"1",
      "Text":"If the enemy had [30|40] or less HP, set their HP to 0.",
   ...
   },
   {
      ...
      "Type":"Attack",
      "Cost":"2",
      "Text":"Deal [10|13] damage. If #Fatal, #Upgrade a random card in your deck. #Exhaust.",
      
   },
   {
      "Name":"Master Reality",
      "Image":"MasterReality.png",
      "Color":"Purple",
      "Rarity":"Rare",
      "Type":"Power",
      "Cost":"1",
